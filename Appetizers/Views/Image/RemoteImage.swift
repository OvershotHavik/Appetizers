...
struct RemoteImage: View{
    ...
    var image: Image?
    var body: some View{
        image?.resizable() ?? Image("food-placeholder").resizable() // If image is nil, use the image in asset as a placeholder
    }
}


struct AppetizerRemoteImage: View{ // Used in the list view as a view
